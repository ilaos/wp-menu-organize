...
<div class="sfb-step-content">
  ...
  <section class="sfb-review sfb-review--mvp" aria-label="Review your packet">
    <div class="sfb-review-grid">
      ...
      <!-- Right: Brand Preview (sidebar) -->
      <aside class="sfb-brand-preview-sidebar" aria-label="Brand preview">
        <div class="sfb-brand-preview-card">
          <h3 class="sfb-brand-preview-title"><?php esc_html_e('Brand Preview', 'submittal-builder'); ?></h3>
          <p class="sfb-brand-preview-subtitle"><?php esc_html_e('Click to preview different themes', 'submittal-builder'); ?></p>

          <div id="sfb-brand-preview-container" class="sfb-brand-preview-container">
            <!-- Theme previews will be injected here -->
          </div>

          <p class="sfb-brand-preview-note">
            <span class="sfb-brand-preview-note-icon">ℹ️</span>
            <?php esc_html_e('Preview only - does not save settings', 'submittal-builder'); ?>
          </p>
        </div>
      </aside>
    </div>
