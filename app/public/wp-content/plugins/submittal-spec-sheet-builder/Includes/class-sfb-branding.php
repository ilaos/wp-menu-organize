...
final class SFB_Branding {
  ...
  public static function save($data) {
    try {
      ...
      return [
        ...
        'message' => __('Brand settings saved successfully', 'submittal-spec-sheet-builder')
      ];
      ...
      return [
        'success' => false,
        'data' => null,
        'message' => __('Server error saving brand settings', 'submittal-spec-sheet-builder')
      ];
    }
  }
  ...
  public static function create_preset($name) {
    ...
    $name = trim($name);
    if (empty($name)) {
      return new WP_Error('invalid_name', __('Preset name is required.', 'submittal-spec-sheet-builder'));
    }
  ...
  public static function apply_preset($id) {
    ...
    if (!$preset) {
      return new WP_Error('preset_not_found', __('Preset not found.', 'submittal-spec-sheet-builder'));
    }
  ...
  public static function ajax_create_preset() {
    ...
    if (!self::is_agency_license()) {
      wp_send_json_error(['message' => __('Brand Presets require an Agency license.', 'submittal-spec-sheet-builder')], 403);
    }
    ...
    wp_send_json_success([
      'message' => __('Preset created successfully.', 'submittal-spec-sheet-builder'),
      'preset' => $result,
    ]);
  }
  ...
  public static function ajax_apply_preset() {
    ...
    wp_send_json_success(['message' => __('Preset applied successfully. Refreshing page...', 'submittal-spec-sheet-builder')]);
  }
  ...
  public static function ajax_rename_preset() {
    ...
    wp_send_json_success(['message' => __('Preset renamed successfully.', 'submittal-spec-sheet-builder')]);
  }
  ...
  public static function ajax_delete_preset() {
    ...
    wp_send_json_success(['message' => __('Preset deleted successfully.', 'submittal-spec-sheet-builder')]);
  }
  ...
  public static function ajax_set_default_preset() {
    ...
    wp_send_json_success(['message' => __('Default preset updated.', 'submittal-spec-sheet-builder')]);
  }
