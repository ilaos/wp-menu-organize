...
class SFB_PDF_Generator {
  ...
  private static function group_products_by_product($products) {
    ...
    foreach ($products as $product) {
      $product_label = $product['product_label'] ?? $product['product'] ?? __('Uncategorized', 'submittal-spec-sheet-builder');
  ...
  private static function group_products_by_category($products) {
    ...
    foreach ($products as $product) {
      $category = $product['category'] ?? $product['path'][0] ?? __('Uncategorized', 'submittal-spec-sheet-builder');
...
<div class="sfb-cover">
  ...
  <div class="cover-content">
    ...
    <div class="cover-subtitle">
      <?php esc_html_e('Submittal & Spec Sheet Packet', 'submittal-spec-sheet-builder'); ?>
    </div>
  ...
  <div class="cover-footer">
    ...
    if (!sfb_is_white_label_enabled()) {
      ...
      ?>
      <?php esc_html_e('Generated using', 'submittal-spec-sheet-builder'); ?>
      <a href="https://webstuffguylabs.com/plugins/submittal-spec-sheet-builder/">
        <?php esc_html_e('Submittal & Spec Sheet Builder', 'submittal-spec-sheet-builder'); ?>
      </a>
      <?php esc_html_e('for WordPress', 'submittal-spec-sheet-builder'); ?>
      <?php
    }
...
<div class="sfb-toc">
  ...
  <h1 class="page-title"><?php esc_html_e('Table of Contents', 'submittal-spec-sheet-builder'); ?></h1>

  <div class="toc-section">
    <div class="toc-section-title"><?php esc_html_e('Overview', 'submittal-spec-sheet-builder'); ?></div>
    <ul>
      <li>
        <a href="#sfb-summary" class="sfb-toc-title">
          <?php esc_html_e('Summary', 'submittal-spec-sheet-builder'); ?>
        </a>
  ...
  <div class="toc-section">
    <div class="toc-section-title"><?php esc_html_e('Model Specifications', 'submittal-spec-sheet-builder'); ?></div>
    <ul>
      <?php
      $page_num++; // Summary page
      foreach ($grouped_products as $product_label => $models):
        foreach ($models as $model):
          $model_name = $model['model'] ?? $model['title'] ?? $model['name'] ?? __('Unnamed Model', 'submittal-spec-sheet-builder');
...
<div class="sfb-summary">
  <div class="sfb-spacer-top"></div>
  <h1 id="sfb-summary" class="page-title"><?php esc_html_e('Summary', 'submittal-spec-sheet-builder'); ?></h1>
  ...
  <?php if (!empty($project_notes)): ?>
    <div class="product-description" style="margin: 20px 0;">
      <strong><?php esc_html_e('Project Notes:', 'submittal-spec-sheet-builder'); ?></strong><br/>
    ...
    <div class="sfb-section sfb-avoid-break">
      <div id="sfb-prod-<?php echo esc_attr($product_slug); ?>" class="sfb-section-title">
        ...
        <span class="text-muted" style="font-weight:400; font-size:10pt;">
          (<?php echo count($models); ?> <?php echo _n('model', 'models', count($models), 'submittal-spec-sheet-builder'); ?>)
        </span>
      </div>
      ...
      <table class="sfb-table">
        <thead>
          <tr>
            <th style="width: 8%;"><?php esc_html_e('Qty', 'submittal-spec-sheet-builder'); ?></th>
            <th style="width: 18%;"><?php esc_html_e('Type', 'submittal-spec-sheet-builder'); ?></th>
            <th style="width: 27%;"><?php esc_html_e('Model', 'submittal-spec-sheet-builder'); ?></th>
            <th style="width: 22%;"><?php esc_html_e('Key Specifications', 'submittal-spec-sheet-builder'); ?></th>
            <th style="width: 25%;"><?php esc_html_e('Notes', 'submittal-spec-sheet-builder'); ?></th>
          </tr>
        </thead>
        <tbody>
...
<div class="product-page">
  ...
  <div class="product-header">
    ...
    <?php if ($quantity > 1): ?>
      <div class="product-subtitle">
        <strong><?php esc_html_e('Quantity:', 'submittal-spec-sheet-builder'); ?></strong> <?php echo esc_html($quantity); ?>
      </div>
    <?php endif; ?>
  </div>
  ...
  <?php if (!empty($description)): ?>
    <div class="product-description">
      <strong><?php esc_html_e('Description:', 'submittal-spec-sheet-builder'); ?></strong><br/>
  ...
  <?php if (!empty($specs)): ?>
    <div class="spec-section">
      <h3 class="spec-section-title"><?php esc_html_e('Technical Specifications', 'submittal-spec-sheet-builder'); ?></h3>
...
<div class="sfb-footer">
  <div class="sfb-footer-text">
    ...
    <?php else: ?>
      <?php esc_html_e('Generated with Submittal & Spec Sheet Builder for WordPress', 'submittal-spec-sheet-builder'); ?>
    <?php endif; ?>
  </div>
  <script type="text/php">
    if (isset($pdf)) {
