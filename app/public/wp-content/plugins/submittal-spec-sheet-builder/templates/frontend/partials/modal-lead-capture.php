...
<div id="sfb-lead-modal" class="sfb-modal" style="display: none;" role="dialog" aria-modal="true" aria-labelledby="sfb-lead-modal-title">
  ...
  <div class="sfb-modal-content">
    <div class="sfb-modal-header">
      <h2 id="sfb-lead-modal-title"><?php esc_html_e('Get your PDF', 'submittal-spec-sheet-builder'); ?></h2>
      <button type="button" class="sfb-modal-close" aria-label="<?php esc_attr_e('Close modal', 'submittal-spec-sheet-builder'); ?>">
    ...
    <div class="sfb-modal-body">
      <p class="sfb-lead-intro">
        <?php esc_html_e('Enter your information to receive your submittal packet.', 'submittal-spec-sheet-builder'); ?>
      </p>
      ...
      <form id="sfb-lead-form" class="sfb-lead-form">
        ...
        <div class="sfb-form-field">
          <label for="sfb-lead-email">
            <?php esc_html_e('Work Email', 'submittal-spec-sheet-builder'); ?>
            <span class="sfb-required" aria-label="<?php esc_attr_e('required', 'submittal-spec-sheet-builder'); ?>">*</span>
          </label>
          <input
            type="email"
            id="sfb-lead-email"
            ...
            required
            autocomplete="email"
            placeholder="<?php esc_attr_e('your.email@company.com', 'submittal-spec-sheet-builder'); ?>"
            aria-required="true"
          >
        </div>
        ...
        <div class="sfb-form-field">
          <label for="sfb-lead-phone">
            <?php esc_html_e('Phone', 'submittal-spec-sheet-builder'); ?>
            <span class="sfb-optional"><?php esc_html_e('(optional)', 'submittal-spec-sheet-builder'); ?></span>
          </label>
          <input
            type="tel"
            id="sfb-lead-phone"
        ...
        <div class="sfb-form-field sfb-checkbox-field">
          <label for="sfb-lead-consent">
            <input
              ...
              value="1"
            >
            <span><?php esc_html_e('Email me updates about products and projects', 'submittal-spec-sheet-builder'); ?></span>
          </label>
        </div>
        ...
        <div class="sfb-form-actions">
          <button
            ...
            disabled
          >
            <span class="sfb-btn-text"><?php esc_html_e('Send me the PDF', 'submittal-spec-sheet-builder'); ?></span>
            <span class="sfb-btn-spinner" style="display: none;">
              <span class="sfb-spinner-small"></span>
              <?php esc_html_e('Processing...', 'submittal-spec-sheet-builder'); ?>
            </span>
          </button>
        </div>
        ...
        <p class="sfb-lead-privacy">
          <?php esc_html_e('We use your info to send the PDF and follow up about this project.', 'submittal-spec-sheet-builder'); ?>
        </p>
      </form>
    </div>
  </div>
