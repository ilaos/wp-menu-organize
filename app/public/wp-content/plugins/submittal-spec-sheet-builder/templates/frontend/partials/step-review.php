...
<div class="sfb-step-content">
  <div class="sfb-step-header">
    <h2><?php esc_html_e('Review', 'submittal-spec-sheet-builder'); ?></h2>
    <p class="sfb-step-description">
      <?php esc_html_e('Review your selected products and add project details.', 'submittal-spec-sheet-builder'); ?>
    </p>
  </div>
  ...
  <section class="sfb-review sfb-review--mvp" aria-label="Review your packet">
    ...
    <div class="sfb-review-main">
      ...
      <div id="sfb-review-empty" class="sfb-review-empty" style="display: none;">
        ...
        <p class="sfb-review-empty__text"><?php esc_html_e('No products selected.', 'submittal-spec-sheet-builder'); ?></p>
        <button type="button" id="sfb-return-to-products" class="sfb-btn sfb-btn-secondary">
          <span class="sfb-icon-arrow-left">←</span>
          <?php esc_html_e('Return to Products', 'submittal-spec-sheet-builder'); ?>
        </button>
      </div>
      ...
      <section class="sfb-project" id="sfb-project" style="margin-top:16px;">
        <label style="display:block;margin:12px 0 6px;font-weight:800;">
          <?php esc_html_e('Project name', 'submittal-spec-sheet-builder'); ?>
          <input
            type="text"
            id="sfb-project-name"
            placeholder="<?php esc_attr_e('e.g., Miller Hall – West Wing', 'submittal-spec-sheet-builder'); ?>"
            style="width:100%;padding:10px;border:1px solid #e5e7eb;border-radius:8px;"
          />
          <span class="sfb-field-helper"><?php esc_html_e('Appears on the first page of your PDF.', 'submittal-spec-sheet-builder'); ?></span>
        </label>
        <label style="display:block;margin:12px 0 6px;font-weight:800;">
          <?php esc_html_e('Project notes', 'submittal-spec-sheet-builder'); ?> <span style="font-weight:400;color:#6b7280;">(<?php esc_html_e('optional', 'submittal-spec-sheet-builder'); ?>)</span>
          <textarea
            id="sfb-project-notes"
            placeholder="<?php esc_attr_e('Add any notes or special instructions…', 'submittal-spec-sheet-builder'); ?>"
  ...
  <div class="sfb-sticky-actions" id="sfb-sticky-actions">
    <button type="button" id="sfb-back-to-products-sticky" class="sfb-btn sfb-btn-secondary">
      <span class="sfb-icon-arrow-left">←</span>
      <?php esc_html_e('Back', 'submittal-spec-sheet-builder'); ?>
    </button>
    <button type="button" id="sfb-generate-pdf-sticky" class="sfb-btn sfb-btn-primary" title="">
      <?php esc_html_e('Generate PDF', 'submittal-spec-sheet-builder'); ?>
