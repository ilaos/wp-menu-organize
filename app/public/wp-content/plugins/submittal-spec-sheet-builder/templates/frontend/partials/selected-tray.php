...
<div id="sfb-selected-tray" class="sfb-selected-tray">
  <div id="sfb-tray-header" class="sfb-tray-header">
    ...
    <button id="sfb-tray-toggle" class="sfb-tray-toggle" type="button"
            aria-label="<?php esc_attr_e('Close selection tray', 'submittal-spec-sheet-builder'); ?>"
            aria-expanded="true"
  ...
  <div id="sfb-tray-body" class="sfb-tray-body">
    <div id="sfb-tray-products-list" class="sfb-tray-products-list" role="list" aria-label="<?php esc_attr_e('Selected products', 'submittal-spec-sheet-builder'); ?>">
      <div class="sfb-tray-empty">
        <p><?php esc_html_e('No products selected yet', 'submittal-spec-sheet-builder'); ?></p>
      </div>
    </div>

    <div class="sfb-tray-actions">
      <button id="sfb-tray-clear-all" class="sfb-btn-text sfb-tray-btn-clear">
        <?php esc_html_e('Clear All', 'submittal-spec-sheet-builder'); ?>
      </button>
      <button id="sfb-tray-continue" class="sfb-btn sfb-btn-primary" disabled>
        <?php esc_html_e('Continue to Review', 'submittal-spec-sheet-builder'); ?>
