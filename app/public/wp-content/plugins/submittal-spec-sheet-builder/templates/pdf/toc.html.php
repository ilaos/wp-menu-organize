  ...
  <ol style="font-size:14px; color:#333; margin:0; padding-left:18px; line-height:1.6;">
    <?php foreach ($items as $i => $it): ?>
      ...
      <li style="margin:3px 0; padding:2px 0;">
        <a href="#<?php echo  esc_attr($anchor_id); ?>" style="color:#1f2937; text-decoration:none;">
          <strong><?php echo  esc_html($item_title); ?></strong> — <span style="color:#6b7280;"><?php echo  esc_html(implode(' › ', $item_crumbs)); ?></span>
        </a>
      </li>
    <?php endforeach; ?>
  </ol>
