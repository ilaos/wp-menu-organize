...
<div class="wrap sfb-onboard" style="max-width: 800px; margin: 40px auto; --sfb-accent: <?php echo esc_attr($primary_color); ?>;">
  <div style="text-align: center; margin-bottom: 40px;">
    <h1 style="font-size: 32px; margin-bottom: 8px;"><?php echo esc_html__('👋 Welcome to Submittal & Spec Sheet Builder!', 'submittal-spec-sheet-builder'); ?></h1>
    <p style="font-size: 16px; color: #6b7280;"><?php echo esc_html__('Let\'s set up your brand and create your first submittal packet.', 'submittal-spec-sheet-builder'); ?></p>
  </div>
  ...
  <?php if ($is_returning): ?>
    ...
    <div id="sfb-returning" class="notice notice-success" style="display:flex;align-items:center;justify-content:space-between;gap:8px;">
      <div>✅ <?php esc_html_e('You\'re all set. Your branding is saved.', 'submittal-spec-sheet-builder'); ?></div>
      <div style="display:flex;gap:8px;">
        <a href="#" id="sfb-edit-branding-toggle" class="button button-secondary"><?php esc_html_e('Edit Branding', 'submittal-spec-sheet-builder'); ?></a>
        <a href="<?php echo esc_url(admin_url('admin.php?page=sfb')); ?>" class="button button-primary" id="sfb-start-builder"><?php esc_html_e('Open Builder', 'submittal-spec-sheet-builder'); ?></a>
      </div>
    </div>
  <?php endif; ?>
  ...
  <div id="sfb-branding-form" class="sfb-card" <?php echo $is_returning ? 'hidden' : ''; ?>>
    <h2 class="sfb-accent-title"><?php echo esc_html__('Quick Setup', 'submittal-spec-sheet-builder'); ?></h2>
    ...
    <div class="sfb-steps" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px; margin-bottom: 24px;">
      <div class="sfb-step" style="background: #fafafa; border: 1px solid #eef0f3; border-radius: 6px; padding: 12px;">
        ...
        <div style="font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 4px;"><?php echo esc_html__('Set your brand', 'submittal-spec-sheet-builder'); ?></div>
        <div style="font-size: 12px; color: #6b7280; line-height: 1.4;"><?php echo esc_html__('Company name, color, and logo appear on your PDFs.', 'submittal-spec-sheet-builder'); ?></div>
      </div>
      <div class="sfb-step" style="background: #fafafa; border: 1px solid #eef0f3; border-radius: 6px; padding: 12px;">
        <div style="font-size: 20px; margin-bottom: 6px;">📦</div>
        <div style="font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 4px;"><?php echo esc_html__('Build your catalog', 'submittal-spec-sheet-builder'); ?></div>
        <div style="font-size: 12px; color: #6b7280; line-height: 1.4;"><?php echo esc_html__('Add categories, products, and spec fields in the Builder.', 'submittal-spec-sheet-builder'); ?></div>
      </div>
      <div class="sfb-step" style="background: #fafafa; border: 1px solid #eef0f3; border-radius: 6px; padding: 12px;">
        <div style="font-size: 20px; margin-bottom: 6px;">🚀</div>
        <div style="font-size: 13px; font-weight: 600; color: #374151; margin-bottom: 4px;"><?php echo esc_html__('Use the shortcode', 'submittal-spec-sheet-builder'); ?></div>
        <div style="font-size: 12px; color: #6b7280; line-height: 1.4;"><?php echo esc_html__('Add [submittal_builder] to any page to publish the form.', 'submittal-spec-sheet-builder'); ?></div>
      </div>
    </div>
    ...
    <form method="post" action="">
      ...
      <div style="margin-bottom: 20px;">
        <label style="display: block; margin-bottom: 6px; font-weight: 600; color: #374151;">
          <?php echo esc_html__('Company Name', 'submittal-spec-sheet-builder'); ?>
        </label>
        <input
          type="text"
          name="company_name"
          value="<?php echo esc_attr($company_name); ?>"
          placeholder="<?php esc_attr_e('e.g., Acme Construction', 'submittal-spec-sheet-builder'); ?>"
          style="width: 100%; padding: 8px 12px; border: 1px solid #d1d5db; border-radius: 4px; font-size: 14px;"
        >
        <p style="margin: 6px 0 0; font-size: 12px; color: #6b7280;">
          <?php echo esc_html__('Appears on PDF cover pages and headers.', 'submittal-spec-sheet-builder'); ?>
        </p>
      </div>
      ...
      <div style="margin-bottom: 20px;">
        <label style="display: block; margin-bottom: 6px; font-weight: 600; color: #374151;">
          <?php echo esc_html__('Brand Color', 'submittal-spec-sheet-builder'); ?>
        </label>
        ...
        <p style="margin: 6px 0 0; font-size: 12px; color: #6b7280;">
          <?php echo esc_html__('Used for headers and accents in PDFs.', 'submittal-spec-sheet-builder'); ?>
        </p>
      </div>
      ...
      <div style="margin-bottom: 24px;">
        <label style="display: block; margin-bottom: 6px; font-weight: 600; color: #374151;">
          <?php echo esc_html__('Logo URL (Optional)', 'submittal-spec-sheet-builder'); ?>
        </label>
        <input
          type="url"
          name="logo_url"
      ...
      <div style="display: flex; gap: 12px; justify-content: flex-end; align-items: center; padding-top: 20px; border-top: 1px solid #e5e7eb;">
        ...
        >
          <?php echo esc_html__('Complete Setup', 'submittal-spec-sheet-builder'); ?>
        </button>
        <a
        ...
        >
          <?php echo esc_html__('Start in Builder', 'submittal-spec-sheet-builder'); ?>
        </a>
      </div>
    </form>
  </div>
  ...
  <div class="sfb-card" style="background: #f9fafb;">
    <h3 class="sfb-accent-title" style="font-size: 16px;">
      <?php echo esc_html__('🚀 What\'s Next?', 'submittal-spec-sheet-builder'); ?>
    </h3>
    <ul style="margin: 0; padding-left: 20px; color: #374151; line-height: 1.8; list-style: none;">
      <li style="margin-bottom: 8px;">
        ...
        <?php echo esc_html__('Build your product catalog in the', 'submittal-spec-sheet-builder'); ?>
        <a href="<?php echo esc_url(admin_url('admin.php?page=sfb')); ?>"><?php echo esc_html__('Builder', 'submittal-spec-sheet-builder'); ?></a>
      </li>
      <li style="margin-bottom: 8px;">
        <span class="dashicons dashicons-admin-appearance" style="color: var(--sfb-accent, #7c3aed); font-size: 16px; margin-right: 8px;"></span>
        <?php echo esc_html__('Adjust branding in', 'submittal-spec-sheet-builder'); ?>
        <a href="<?php echo esc_url(admin_url('admin.php?page=sfb-branding')); ?>"><?php echo esc_html__('Settings → Branding', 'submittal-spec-sheet-builder'); ?></a>
      </li>
      <li style="margin-bottom: 8px;">
        <span class="dashicons dashicons-admin-page" style="color: var(--sfb-accent, #7c3aed); font-size: 16px; margin-right: 8px;"></span>
        <?php echo esc_html__('Publish the form using the [submittal_builder] shortcode', 'submittal-spec-sheet-builder'); ?>
        <div style="display: flex; gap: 8px; align-items: center; margin-top: 6px; margin-left: 32px;">
          ...
          <button
            ...
            onclick="navigator.clipboard.writeText('[submittal_builder]'); this.textContent='<?php esc_attr_e('Copied!', 'submittal-spec-sheet-builder'); ?>'; setTimeout(()=>this.textContent='<?php esc_attr_e('Copy', 'submittal-spec-sheet-builder'); ?>',1500);"
            style="white-space: nowrap;"
          >
            <?php echo esc_html__('Copy', 'submittal-spec-sheet-builder'); ?>
          </button>
        </div>
      </li>
      <li>
        <span class="dashicons dashicons-star-filled" style="color: var(--sfb-accent, #7c3aed); font-size: 16px; margin-right: 8px;"></span>
        <?php echo esc_html__('Explore Pro features later', 'submittal-spec-sheet-builder'); ?>
        <?php if (function_exists('sfb_is_pro_active') && sfb_is_pro_active()): ?>
          <a href="<?php echo esc_url(admin_url('admin.php?page=sfb-license')); ?>"><?php echo esc_html__('License & Support', 'submittal-spec-sheet-builder'); ?></a>
        <?php else: ?>
          <a href="https://webstuffguylabs.com/plugins/submittal-spec-sheet-builder-pro/" target="_blank" rel="noopener noreferrer"><?php echo esc_html__('Upgrade', 'submittal-spec-sheet-builder'); ?></a>
        <?php endif; ?>
      </li>
    </ul>
  </div>
