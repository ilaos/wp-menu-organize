...
?>
    <div class="wmo-menu-item-wrapper <?php echo $is_submenu ? 'wmo-submenu-wrapper' : ''; ?>" data-menu-slug="<?php echo esc_attr($unique_slug); ?>" data-original-slug="<?php echo esc_attr($sanitized_slug); ?>">
        ...
        <!-- Compact Header - REMOVED onclick, added wmo-toggle-header class -->
        <div class="wmo-menu-header wmo-toggle-header" data-toggle-slug="<?php echo esc_attr($unique_slug); ?>">
            ...
            <div class="wmo-menu-actions">
                <!-- Color picker moved to Typography section -->
        ...
        <div class="wmo-expanded-content" id="wmo-expanded-<?php echo esc_attr($unique_slug); ?>" style="display: none;">
            ...
            <div class="wmo-typography-wrapper">
                ...
                <div class="wmo-typography-controls" style="<?php echo $typography_enabled ? '' : 'display: none;'; ?>">
                    ...
                    <!-- Main Menu Color Picker (moved from header) -->
                    <div class="wmo-typography-field">
                    ...
                    <!-- Typography Preview -->
                    <div class="wmo-typography-preview">
                ...
                <!-- Icon Section -->
                <div class="icon-section" style="margin-top: 20px; padding: 15px; border: 1px solid #ddd;">
                    <label>
                        <input type="checkbox" class="enable-custom-icon" data-menu-slug="<?php echo esc_attr($sanitized_slug); ?>">
                        ...
                        <div class="emoji-picker" style="display: block;">
                            <div class="icon-picker-grid">
                                ...
                                <div class="emoji-category" data-category="common">
                                    ...
                                    <span class="emoji-option" data-emoji="ðŸ " data-category="common">ðŸ </span>
                                    <span class="emoji-option" data-emoji="ðŸ“Š" data-category="common">ðŸ“Š</span>
                                    <span class="emoji-option" data-emoji="ðŸ“" data-category="common">ðŸ“</span>
                                    <span class="emoji-option" data-emoji="ðŸ“" data-category="common">ðŸ“</span>
                                    <span class="emoji-option" data-emoji="ðŸŽ¨" data-category="common">ðŸŽ¨</span>
                                    <span class="emoji-option" data-emoji="ðŸ”§" data-category="common">ðŸ”§</span>
                                    <span class="emoji-option" data-emoji="âš™ï¸" data-category="common">âš™ï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸ‘¥" data-category="common">ðŸ‘¥</span>
                                    <span class="emoji-option" data-emoji="ðŸ“§" data-category="common">ðŸ“§</span>
                                    <span class="emoji-option" data-emoji="ðŸ’¬" data-category="common">ðŸ’¬</span>
                                </div>
                                ...
                                <div class="emoji-category" data-category="business">
                                    ...
                                    <span class="emoji-option" data-emoji="ðŸ’¼" data-category="business">ðŸ’¼</span>
                                    <span class="emoji-option" data-emoji="ðŸ“ˆ" data-category="business">ðŸ“ˆ</span>
                                    <span class="emoji-option" data-emoji="ðŸ“‰" data-category="business">ðŸ“‰</span>
                                    <span class="emoji-option" data-emoji="ðŸ’°" data-category="business">ðŸ’°</span>
                                    <span class="emoji-option" data-emoji="ðŸ’³" data-category="business">ðŸ’³</span>
                                    <span class="emoji-option" data-emoji="ðŸ¢" data-category="business">ðŸ¢</span>
                                    <span class="emoji-option" data-emoji="ðŸ“‹" data-category="business">ðŸ“‹</span>
                                    <span class="emoji-option" data-emoji="âœ…" data-category="business">âœ…</span>
                                    <span class="emoji-option" data-emoji="ðŸ“Œ" data-category="business">ðŸ“Œ</span>
                                    <span class="emoji-option" data-emoji="ðŸŽ¯" data-category="business">ðŸŽ¯</span>
                                </div>
                                
                                <!-- Tech -->
                                <div class="emoji-category" data-category="tech">
                                    <div style="font-weight: bold; margin-bottom: 5px; color: #666;">Tech</div>
                                    <span class="emoji-option" data-emoji="ðŸ’»" data-category="tech">ðŸ’»</span>
                                    <span class="emoji-option" data-emoji="ðŸ–¥ï¸" data-category="tech">ðŸ–¥ï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸ“±" data-category="tech">ðŸ“±</span>
                                    <span class="emoji-option" data-emoji="âŒ¨ï¸" data-category="tech">âŒ¨ï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸ–±ï¸" data-category="tech">ðŸ–±ï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸ’¾" data-category="tech">ðŸ’¾</span>
                                    <span class="emoji-option" data-emoji="ðŸ’¿" data-category="tech">ðŸ’¿</span>
                                    <span class="emoji-option" data-emoji="ðŸ”Œ" data-category="tech">ðŸ”Œ</span>
                                    <span class="emoji-option" data-emoji="ðŸ”‹" data-category="tech">ðŸ”‹</span>
                                    <span class="emoji-option" data-emoji="ðŸ“¡" data-category="tech">ðŸ“¡</span>
                                </div>
                                ...
                                <div class="emoji-category" data-category="creative">
                                    ...
                                    <span class="emoji-option" data-emoji="âœï¸" data-category="creative">âœï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸ–Œï¸" data-category="creative">ðŸ–Œï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸŽ­" data-category="creative">ðŸŽ­</span>
                                    <span class="emoji-option" data-emoji="ðŸŽª" data-category="creative">ðŸŽª</span>
                                    <span class="emoji-option" data-emoji="ðŸŽ¬" data-category="creative">ðŸŽ¬</span>
                                    <span class="emoji-option" data-emoji="ðŸŽ¤" data-category="creative">ðŸŽ¤</span>
                                    <span class="emoji-option" data-emoji="ðŸŽ§" data-category="creative">ðŸŽ§</span>
                                    <span class="emoji-option" data-emoji="ðŸŽµ" data-category="creative">ðŸŽµ</span>
                                    <span class="emoji-option" data-emoji="ðŸŽ¸" data-category="creative">ðŸŽ¸</span>
                                    <span class="emoji-option" data-emoji="ðŸŽ¹" data-category="creative">ðŸŽ¹</span>
                                </div>
                                ...
                                <div class="emoji-category" data-category="tools">
                                    ...
                                    <span class="emoji-option" data-emoji="ðŸ”¨" data-category="tools">ðŸ”¨</span>
                                    <span class="emoji-option" data-emoji="ðŸ”©" data-category="tools">ðŸ”©</span>
                                    <span class="emoji-option" data-emoji="âš’ï¸" data-category="tools">âš’ï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸ› ï¸" data-category="tools">ðŸ› ï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸ”" data-category="tools">ðŸ”</span>
                                    <span class="emoji-option" data-emoji="ðŸ”“" data-category="tools">ðŸ”“</span>
                                    <span class="emoji-option" data-emoji="ðŸ”‘" data-category="tools">ðŸ”‘</span>
                                    <span class="emoji-option" data-emoji="ðŸ—ï¸" data-category="tools">ðŸ—ï¸</span>
                                    <span class="emoji-option" data-emoji="ðŸ”" data-category="tools">ðŸ”</span>
                                    <span class="emoji-option" data-emoji="ðŸ”Ž" data-category="tools">ðŸ”Ž</span>
                                </div>
                                
                                <!-- Nature -->
                                <div class="emoji-category" data-category="nature">
                                    <div style="font-weight: bold; margin-bottom: 5px; color: #666;">Nature</div>
                                    <span class="emoji-option" data-emoji="ðŸŒŸ" data-category="nature">ðŸŒŸ</span>
                                    <span class="emoji-option" data-emoji="â­" data-category="nature">â­</span>
                                    <span class="emoji-option" data-emoji="âœ¨" data-category="nature">âœ¨</span>
                                    <span class="emoji-option" data-emoji="âš¡" data-category="nature">âš¡</span>
                                    <span class="emoji-option" data-emoji="ðŸ”¥" data-category="nature">ðŸ”¥</span>
                                    <span class="emoji-option" data-emoji="ðŸ’§" data-category="nature">ðŸ’§</span>
                                    <span class="emoji-option" data-emoji="ðŸŒŠ" data-category="nature">ðŸŒŠ</span>
                                    <span class="emoji-option" data-emoji="ðŸƒ" data-category="nature">ðŸƒ</span>
                                    <span class="emoji-option" data-emoji="ðŸŒ¿" data-category="nature">ðŸŒ¿</span>
                                    <span class="emoji-option" data-emoji="ðŸŒ³" data-category="nature">ðŸŒ³</span>
                                </div>
                                ...
                                <div class="emoji-category" data-category="arrows">
                                    ...
                                    <span class="emoji-option" data-emoji="â¬†ï¸" data-category="arrows">â¬†ï¸</span>
                                    <span class="emoji-option" data-emoji="âž¡ï¸" data-category="arrows">âž¡ï¸</span>
                                    <span class="emoji-option" data-emoji="â¬‡ï¸" data-category="arrows">â¬‡ï¸</span>
                                    <span class="emoji-option" data-emoji="â¬…ï¸" data-category="arrows">â¬…ï¸</span>
                                    <span class="emoji-option" data-emoji="â†—ï¸" data-category="arrows">â†—ï¸</span>
                                    <span class="emoji-option" data-emoji="â†˜ï¸" data-category="arrows">â†˜ï¸</span>
...
// wmo_validate_ajax_request() is now defined in error-handler.php
